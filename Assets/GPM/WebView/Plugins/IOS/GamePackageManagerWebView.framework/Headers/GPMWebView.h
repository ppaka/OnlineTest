...
typedef void(^GPMWebViewPageLoadCompletion) (NSString *url);
...
/**
 ...
 @param pageLoadCompletion This completion would be called when page loading is finished
...
+ (void)showWithURL:(NSString *)urlString
 ...
 pageLoadCompletion:(GPMWebViewPageLoadCompletion)pageLoadCompletion
